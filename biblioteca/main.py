...
def main():
    ...
    # Adicionando vértices com rótulos como strings representando os números
    grafo_nao_direcionado.adicionar_vertice(0, "0")
    grafo_nao_direcionado.adicionar_vertice(1, "1")
    grafo_nao_direcionado.adicionar_vertice(2, "2")
    grafo_nao_direcionado.adicionar_vertice(3, "3")
    grafo_nao_direcionado.adicionar_vertice(4, "4")
    grafo_nao_direcionado.adicionar_vertice(5, "5")
    grafo_nao_direcionado.adicionar_vertice(6, "6")

    # Adicionando arestas com rótulos de a1 a a7
    grafo_nao_direcionado.adicionar_aresta(0, 1, "a1")
